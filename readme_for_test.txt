...
A python venv for managing python libs was created
...
TODO: Requirements file for libs
...
Then, you can run your tests with coverage measurement by using the coverage run command, followed by the command to run your tests. For example:

coverage run -m pytest

Once the tests have been completed, you can generate a coverage report using the coverage report command. This will show you the percentage of lines in your code that have been executed by the tests.
